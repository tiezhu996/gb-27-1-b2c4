...
export const courseApi = {
  ...
  reportProgress: (courseId: string, lessonId: string, data: { position: number; duration: number }) =>
    api.post<LessonProgress>(`/courses/${courseId}/lessons/${lessonId}/progress`, data).then(res => res.data),
};
